<?php
    class Post{
        ...
        public function details($slug){
            ...
            $sfield = 'slug';
            $values = array($slug);
            $query = $database -> read_filter_once($table, $fields, $sfield, $values);
            $post = $query -> fetch();
            return $post;
        ...
        public function get_comment_author ($author) {
            ...
            $query = $database -> read_filter_once($table, $fields, $sfield, array($author));
            return $query;
        }
        ...
        public function reply_to_comment ($body, $author, $post, $parent) {
            ...
            echo '<script>alert("Votre réponse a été envoyée avec succes.")</script>';
        ...
        public function get_replies ($post, $parent) {
            ...
            $query = $database -> read_filter_and($table, $fields, $sfield1, $sfield2, $sfield3, array($post, 1, $parent));
            return $query;
        }

        public function check_like ($author ,$post) {
            require_once 'app/core/database/models.php';
            $database = new Model();
            ...
            $query = $database -> read_filter_and($table, $fields, $sfield1, $sfield2, $sfield3, array($author ,$post));
